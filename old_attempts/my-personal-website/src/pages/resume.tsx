...
// Dynamically import our ResumeViewer component with SSR turned off
// This is still best practice for PDF viewers
...
const Resume: NextPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Resume | Stephen Newby</title>
            ...
            <section className="py-12 text-center">
                ...
                <a
                    href={resumeUrl}
                    download="StephenNewby_Resume.pdf"
